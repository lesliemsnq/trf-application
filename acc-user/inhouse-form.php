...
<html lang="en">
  ...
  <?php  if (isset($_SESSION['username'])) : ?>
   <!-- START OF THE NAVBAR -->
    ...
    <main class="main" style="height:1500px;">
    <section class="container">
      ...
      <form action="inhouse.php" class="form" method="POST">
        ...
        <!-- TYPE OF ACTIVITY -->
        <div class="activity">
          <label for="activity">For InHouse</label>
          <br>
          <input type="radio" id="inhhouse" name="inhouse" value="in-house" checked>
        ...
        <!-- DEPARTMENT UNIT -->
        <div class="input-box">
          <label for="odu">Organizing Department/Unit</label>
