...
<html lang="en">
  ...
  <?php  if (isset($_SESSION['username'])) : ?>
   <!-- START OF THE NAVBAR -->
    ...
    <main class="main" style="height: 1770px;">
    <section class="container">
      <header>Individual Training Report(Online)</header>

      <form action="ol-report.php" class="form" method="POST">
        <!-- REPORT HEADLINE -->
        ...
        <div class="input-box">
          <label for="training">Title of Seminar/Training/Conference/Meeting Attended</label>
          <input type="text" id="training" name="training" required />
        </div>
        <div class="input-box">
          <label for="venue_date">Venue & Date/s</label>
          <input type="text" id="venue_date" name="venue_date" required />
        </div>
        <div class="input-box">
          <label for="training">Inviting Organization</label>
        ...
        <p><b>1.</b> Overall, did you find the activity relevant to your work? Why or why not?</p>
        ...
        <br>
        <!-- UPLOADING FILES -->
        <p>Soft copy of certificate of completion or paticipation. <b><i>In the absence of printable certificate of completion for FREE webinars, a confirmation or acknowledgement email from organizer/provider and at least three screenshots may be submitted</i></b></p>
        <br>
        <div class="upload">
            <input type="file" name="file">
        </div>
        ...
        <br>
        <p>Soft copy of resource materials and/or video recording provided</p>
        <br>
        <div class="upload">
            <input type="file" name="file">
        </div>
